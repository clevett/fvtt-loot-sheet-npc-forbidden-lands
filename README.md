# Loot Sheet NPC Forbidden Lands
...
A loot sheet allows players with the right permissions to loot items from it, while a merchant sheet lets them purchase the items in exchange for currency.

### History

Created from [jopeek's 5e module](https://github.com/jopeek/fvtt-loot-sheet-npc-5e).
